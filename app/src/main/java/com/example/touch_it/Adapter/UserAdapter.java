package com.example.touch_it.Adapter;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ((FragmentActivity)mContext).getSupportFragmentManager().beginTransaction().replace(R.id.main_frame, new ImFragment()).commit();
            }
        });
        ...
        viewHolder.btn_follow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (viewHolder.btn_follow.getText().toString().equals("follow")) {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Follow").child(firebaseUser.getUid()).child("followers")
